            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li>
                            <a class="nav-link active" href="/OrderController?action=viewAcceptedOrder&cusID=<%=user.getUserID()%>">Accepted Orders</a>
                        </li>
                        <li>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Accepted Orders</h2>
				</div>
			</div>
						  ...
						  <tbody>
						    <tr>
						      ...
						      <td><%=ofc.findQuantityFoodByOrderDate(dto.getOrderDate())%></td>
                                                      ...
                                                      <td><a style="font-size:24px;text-decoration: none" href="/Order_FoodController?action=viewAcceptedOrderDetail&username=<%=user.getUsername()%>&orderID=<%=dto.getOrderID()%>" class="fa fa-info-circle"></a></td>
						    </tr>
						  </tbody>
                                                  <% }%>
						</table>
