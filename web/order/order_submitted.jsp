...
<html>
	...
	<link rel="stylesheet" href="css/style.css">
        ...
        <%
                    ...
                    Order_FoodController ofc= (Order_FoodController) request.getAttribute("order_food");
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li>
                            <a class="nav-link active" href="/OrderController?action=viewSubmittedOrder&cusID=<%=user.getUserID()%>">Submitted Orders</a>
                        </li>
                        <li class="nav-item">
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Submited Orders</h2>
				</div>
			</div>
				...
				<div class="col-md-12">
					<div class="table-wrap">
						<table class="table table-striped">
						  ...
						  <tbody>
						    <tr>
                                                        <th scope="row"><%=dto.getOrderID()%></th>
						      ...
						      <td><%=ofc.findQuantityFoodByOrderDate(dto.getOrderDate())%></td>
                                                      ...
                                                      <td><a style="font-size:24px;text-decoration: none" href="/Order_FoodController?action=viewSubmittedOrderDetail&username=<%=user.getUsername()%>&orderID=<%=dto.getOrderID()%>" class="fa fa-info-circle"></a></td>
						    </tr>
						  </tbody>
                                                  <% }%>
						</table>
