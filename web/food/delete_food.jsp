...
position:initial!important
    ...
    <body>
        ...
        %>
        <form action="/FoodController?action=deleteFood" method="Post">
                ...
                <ul class="form-section page-section">
                    <li id="cid_1" class="form-input-wide" data-type="control_head">
                        <div class="form-header-group  header-large">
                            <div class="header-text httac htvam">
                                <h1 id="header_1" class="form-header" data-component="header">Are you sure?</h1>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="form-line" data-type="control_button" id="id_2">
                        <div id="cid_2" class="form-input-wide">
                            <div data-align="auto" class="form-buttons-wrapper form-buttons-auto   jsTest-button-wrapperField"><button id="input_2" type="submit" class="form-submit-button form-submit-button-simple_blue submit-button jf-form-buttons jsTest-submitField" data-component="button" data-content="">Delete</button><span> </span><button id="input_reset_2" type="button" class="form-submit-button form-submit-button-simple_grey submit-button jf-form-buttons jsTest-submitField" data-component="button"><a style="text-decoration: none;color: white" href="/FoodController?action=viewDetailMyFood&cusID=<%=user.getUserID()%>&foodID=<%=food.getFoodID()%>">Cancel</a></button></div>
                        </div>
                    </li>
                </ul>
            </div>
